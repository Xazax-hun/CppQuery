...
CppHighlighter::CppHighlighter(QTextDocument* parent)
	...
	keywords << R"(\balignas\b)" << R"(\balignof\b)" << R"(\band\b)"
			<< R"(\band_eq\b)" << R"(\basm\b)" << R"(\bauto\b)"
			<< R"(\bbitand\b)" << R"(\bbitor\b)" << R"(\bbool\b)"
			<< R"(\bbreak\b)" << R"(\bcase\b)" << R"(\bcatch\b)"
			<< R"(\bchar\b)" << R"(\bchar16_t\b)" << R"(\bchar32_t\b)"
			<< R"(\bclass\b)" << R"(\bcompl\b)" << R"(\bconst\b)"
			<< R"(\bconstexpr\b)" << R"(\bconst_cast\b)" << R"(\bcontinue\b)"
			<< R"(\bdecltype\b)" << R"(\bdefault\b)" << R"(\bdelete\b)"
			<< R"(\bdo\b)" << R"(\bdouble\b)" << R"(\bdynamic_cast\b)"
			<< R"(\belse\b)" << R"(\benum\b)" << R"(\bexplicit\b)"
			<< R"(\bexport\b)" << R"(\bextern\b)" << R"(\bfalse\b)"
			<< R"(\bfinal\b)" << R"(\bfloat\b)" << R"(\bfor\b)"
			<< R"(\bfriend\b)" << R"(\bgoto\b)" << R"(\bif\b)"
			<< R"(\binline\b)" << R"(\bint\b)" << R"(\blong\b)"
			<< R"(\bmutable\b)" << R"(\bnamespace\b)" << R"(\bnew\b)"
			<< R"(\bnoexcept\b)" << R"(\bnot\b)" << R"(\bnot_eq\b)"
			<< R"(\bnullptr\b)" << R"(\boperator\b)" << R"(\bor\b)"
			<< R"(\bor_eq\b)" << R"(\boverride\b)" << R"(\bprivate\b)"
			<< R"(\bprotected\b)" << R"(\bpublic\b)" << R"(\bregister\b)"
			<< R"(\breinterpret_cast\b)" << R"(\breturn\b)" << R"(\bshort\b)"
			<< R"(\bsigned\b)" << R"(\bsizeof\b)" << R"(\bstatic\b)"
			<< R"(\bstatic_assert\b)" << R"(\bstatic_cast\b)" << R"(\bstruct\b)"
			<< R"(\bswitch\b)" << R"(\btemplate\b)" << R"(\bthis\b)" << R"(\bthread_local\b)"
			<< R"(\bthrow\b)" << R"(\btrue\b)" << R"(\btry\b)"
			<< R"(\btypedef\b)" << R"(\btypeid\b)" << R"(\btypename\b)"
			<< R"(\bunion\b)" << R"(\bunsigned\b)" << R"(\busing\b)"
			<< R"(\bvirtual\b)" << R"(\bvoid\b)" << R"(\bvolatile\b)"
			<< R"(\bwchar_t\b)" << R"(\bwhile\b)" << R"(\bxor\b)"
			<< R"(\bxor_eq \b)" << R"(\bslots\b)" << R"(\bsignals\b)";
